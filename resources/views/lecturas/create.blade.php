        ...
        <div class="flex flex-col gap-4 sm:flex-row sm:items-end sm:justify-between">
            <div>
                ...
                <p class="mt-2 text-sm text-slate-600">
                    Registra un nuevo libro y define su estado dentro de tu seguimiento lector.
                </p>
            </div>
    ...
    <div class="bg-slate-50 py-10">
        <div class="mx-auto max-w-3xl px-4 sm:px-6 lg:px-8">
            <div class="rounded-3xl border border-slate-200 bg-white p-6 shadow-sm sm:p-8">
                <form action="{{ route('lecturas.store') }}" method="POST" class="space-y-6">
                    @csrf
                    ...
                    <div>
                        ...
                        <x-text-input
                            ...
                            required
                            autofocus
                            placeholder="Ejemplo: Atomic Habits" />
                    ...
                    <div>
                        ...
                        <x-text-input
                            ...
                            class="mt-2 block w-full"
                            :value="old('autor')"
                            placeholder="Ejemplo: James Clear" />
                    ...
                    <div>
                        ...
                        <select
                            ...
                            <option value="leyendo" {{ old('estado') == 'leyendo' ? 'selected' : '' }}>Leyendo</option>
                            <option value="leido" {{ old('estado') == 'leido' ? 'selected' : '' }}>Leído</option>
                        </select>
